...
<div class="header">
 <h2>The Green Grocer : Tri-Tech Skills Center Project <br />
<a href= "index.php?id=1001" class= "menu">APPPLES:1001</a> <a href= "index.php?id=1002" class= "menu">APPPLES:1002</a> 
<a href= "index.php?id=1003" class= "menu">APPPLES:1003</a> 
<a href= "index.php?id=2001" class= "menu">BANANAS:2001</a> 
<a href= "index.php?id=2002" class= "menu">LETTUCE:3001</a> <a href= "index.php?id=2002" class= "menu">POTATOES:4001</a> 
<a href= "index.php?id=2002" class= "menu">TOMATOES:5001</a>
<a href= "selectall.php" class= "menu">SHOW ALL DATA</a> 
  ...
  <p>
	  ...
	  $idselected = $_GET['id']; 
		...
		while ($row = mysql_fetch_row($result)){
			...
			if ($row[3] > 1000 && $row[3] < 2000)$photo = "photos/apples.jpg";
				if ($row[3] > 2000 && $row[3] < 3000)$photo = "photos/bananas.jpg";
					if ($row[3] > 3000 && $row[3] < 4000)$photo = "photos/lettuce.jpg";
						if ($row[3] > 4000 && $row[3] < 5000)$photo = "photos/potatoes.jpg";
							if ($row[3] > 5000 && $row[3] < 6000)$photo = "photos/tomatoes.jpg";
